...
exports.withBeepWidgetIOS = void 0;
...
const withWidgetExtensionFiles = (config) => {
    return (0, config_plugins_1.withDangerousMod)(config, [
        ...
        (mod) => {
            ...
            const moduleSrcDir = path.join(projectRoot, "modules", "beep-widget", "ios");
            // Copy widget extension files to ios/ directory
            const widgetDstDir = path.join(mod.modRequest.platformProjectRoot, WIDGET_EXTENSION_NAME);
